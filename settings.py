...
SECRET_KEY = 'pm-rgfz2#yfo@cx@m!9b@qlrwzcxmg!_tp8m*f0f@rvykc+1eu'
...
SESSION_ENGINE = 'libs.appengine_sessions.backends.db'

TEMPLATE_CONTEXT_PROCESSORS = (
    'libs.djangoflash.context_processors.flash',
)

MIDDLEWARE_CLASSES = (
    'mediagenerator.middleware.MediaMiddleware',
    'django.middleware.common.CommonMiddleware',
    'libs.appengine_sessions.middleware.SessionMiddleware',
